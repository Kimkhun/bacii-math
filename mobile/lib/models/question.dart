...
class Question {
  ...
  factory Question.fromJson(Map<String, dynamic> json) {
    ...
    if (rawParts != null) {
      parsedParts = rawParts.map((p) => QuestionPart.fromJson(p as Map<String, dynamic>)).toList();
    } else if (json['params'] != null && json['params']['parts'] != null) {
      var pList = json['params']['parts'] as List<dynamic>;
      parsedParts = pList.map((p) => QuestionPart.fromJson(p as Map<String, dynamic>)).toList();
    }
    ...
    return Question(
      ...
      formulaTags: (json['formula_tags'] as List<dynamic>?)?.map((e) => e.toString()).toList() ?? [],
