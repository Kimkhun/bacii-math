...
const TYPE_OPTIONS: Record<string, { value: string; label: string }[]> = {
  ...
  integral: [
    ...
    { value: "indefinite_integral:indefinite_sum", label: "Indefinite — sum of several term types" },
  ],
  probability: [
    ...
    { value: "counting", label: "Counting (any)" },
    { value: "counting:combination", label: "Counting — combinations C(n, r)" },
    { value: "counting:permutation", label: "Counting — permutations P(n, r)" },
  ],
  functions: [{ value: "study", label: "Curve study & area" }],
  continuity: [
    { value: "check_continuity", label: "Continuity (any)" },
    { value: "check_continuity:check_at_point", label: "Check continuity at a point" },
    { value: "check_continuity:find_parameter", label: "Find the parameter that makes it continuous" },
  ],
  derivatives: [
  ...
  differential_equations: [
    { value: "solve_ode", label: "Differential equation (any)" },
    { value: "solve_ode:first_order_linear_homogeneous", label: "y' + ay = 0" },
    { value: "solve_ode:first_order_linear_nonhomogeneous", label: "y' + ay = g(x)" },
    { value: "solve_ode:second_order_homogeneous_constant_coeff", label: "y'' + by' + cy = 0" },
    { value: "solve_ode:second_order_nonhomogeneous", label: "y'' + by' + cy = g(x)" },
  ],
  vectors_space: [
    { value: "vector_ops", label: "Vector operations (any)" },
    { value: "vector_ops:magnitude", label: "Magnitude of a vector |AB|" },
    { value: "vector_ops:distance", label: "Distance between two points" },
    { value: "vector_ops:dot", label: "Dot product AB · AC" },
    { value: "vector_ops:find_m_orthogonal", label: "Find m making two vectors orthogonal" },
    { value: "vector_ops:cross_magnitude", label: "Cross product magnitude |AB × AC|" },
    { value: "vector_ops:triangle_area", label: "Area of a triangle" },
    { value: "vector_ops:scalar_triple_product", label: "Scalar triple product u · (v × w)" },
  ],
  conics: [
    { value: "classify_conic", label: "Conics (any)" },
    { value: "classify_conic:vertex_x", label: "Parabola — vertex (x)" },
    { value: "classify_conic:vertex_y", label: "Parabola — vertex (y)" },
    { value: "classify_conic:p", label: "Parabola — focal parameter p" },
    { value: "classify_conic:focus_x", label: "Parabola — focus (x)" },
    { value: "classify_conic:focus_y", label: "Parabola — focus (y)" },
    { value: "classify_conic:directrix", label: "Parabola — directrix" },
    { value: "classify_conic:center_x", label: "Ellipse / hyperbola — centre (x)" },
    { value: "classify_conic:center_y", label: "Ellipse / hyperbola — centre (y)" },
    { value: "classify_conic:a", label: "Ellipse / hyperbola — a" },
    { value: "classify_conic:b", label: "Ellipse / hyperbola — b" },
    { value: "classify_conic:c", label: "Ellipse / hyperbola — focal distance c" },
  ],
};
