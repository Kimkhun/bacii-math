...
from sympy import N, Symbol, diff, integrate, latex, limit, log, logcombine, oo, simplify, solve, sympify
...
def _build_graph(params, x, expr):
    ...
    if t:
        ...
        tangent = [[round(xa, 4), round(ya, 4)], [round(xb, 4), round(yb, 4)]]
