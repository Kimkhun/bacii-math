...
(data/curated/*.json) supplies the MoEYS narration text. Assembly mirrors the
probability topic's multi-part pattern (work_mode "any_order", part-labeled
steps and checkpoints, target = last part)."""
