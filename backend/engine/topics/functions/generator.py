...
problems) loaded once at import from data/curated/*.json — the same
curated-replay pattern as the limit topic. The exercise card carries the full
part list and the MoEYS narration; SymPy recomputes every answer at solve time."""
import json
import os
